public class Rational
{
    ...
    {
        int gcd = greatestCommonFactor(r.denominator, r.numerator);
        int newDenominator = r.denominator / gcd;
        int newNumerator = r.numerator / gcd;
        Rational simplifiedRational = new Rational(newNumerator, newDenominator);
